...
type alias Model =
    ...
    , apiUrl : String
    , page : Route -- TODO: rename to page?
    }
...
update msg model =
    case msg of
        ...
        SignInEmailOrUsername value ->
            case model.page of
                Router.SignInPage details ->
                    let
                        newDetails =
                            { details | emailOrUsername = value }
                    in
                    ( { model | page = Router.SignInPage newDetails }, Cmd.none )
            ...
            [ case model.userToken of
                ...
                Nothing ->
                    ...
                    div []
                        ...
                        , span [] [ text ", " ]
                        , a [ href "/sign-up", class "sign-up-link" ]
                            [ text "Sign up" ]
                        ]
            ]
        ]
...
viewBody model =
    case model.page of
        ...
        Router.AdminUsers list ->
            Views.Admin.view model list

        Router.Contact ->
            Views.Contact.view

        Router.Roadmaps list ->
            Views.RoadmapsList.view model list

        Router.SignInPage details ->
            Views.SignIn.view details AttemptSignIn SignInEmailOrUsername SignInPassword
        ...
        -- TODO: turn this back into explicit "Unknown"
        _ ->
...
footerLink path linkText =
    ...
    -- in
    li [] [ a [ href path ] [ text linkText ] ]



-- TODO: restore active link highlighting
